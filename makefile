...
.NOTPARALLEL: $(DEXE)STRINGIFOR-DOCTEST-1                   \
              ...
              $(DEXE)STRINGIFOR_TEST_CSV_NAIVE_PARSER       \
              ...
              $(DEXE)FACE_TEST_STYLES                       \
              $(DEXE)FACE_TEST_BASIC                        \
              $(DEXE)FACE_TEST_COLORS                       \
              $(DEXE)FACE_TEST_UCS4
...
$(DEXE)FACE_TEST_STYLES: $(MKDIRS) $(DOBJ)face_test_styles.o
	@rm -f $(filter-out $(DOBJ)face_test_styles.o,$(EXESOBJ))
	@echo $(LITEXT)
	@$(FC) $(OPTSL) $(DOBJ)*.o $(LIBS) -o $@
EXES := $(EXES) FACE_TEST_STYLES
$(DEXE)FACE_TEST_BASIC: $(MKDIRS) $(DOBJ)face_test_basic.o
	@rm -f $(filter-out $(DOBJ)face_test_basic.o,$(EXESOBJ))
	@echo $(LITEXT)
	@$(FC) $(OPTSL) $(DOBJ)*.o $(LIBS) -o $@
EXES := $(EXES) FACE_TEST_BASIC
$(DEXE)FACE_TEST_COLORS: $(MKDIRS) $(DOBJ)face_test_colors.o
	@rm -f $(filter-out $(DOBJ)face_test_colors.o,$(EXESOBJ))
	@echo $(LITEXT)
	@$(FC) $(OPTSL) $(DOBJ)*.o $(LIBS) -o $@
EXES := $(EXES) FACE_TEST_COLORS
$(DEXE)FACE_TEST_UCS4: $(MKDIRS) $(DOBJ)face_test_ucs4.o
	@rm -f $(filter-out $(DOBJ)face_test_ucs4.o,$(EXESOBJ))
	@echo $(LITEXT)
	@$(FC) $(OPTSL) $(DOBJ)*.o $(LIBS) -o $@
...
$(DOBJ)face_test_styles.o: src/third_party/FACE/src/tests/face_test_styles.f90 \
	$(DOBJ)face.o
	@echo $(COTEXT)
	@$(FC) $(OPTSC)  $< -o $@

$(DOBJ)face_test_basic.o: src/third_party/FACE/src/tests/face_test_basic.f90 \
	$(DOBJ)face.o
	@echo $(COTEXT)
	@$(FC) $(OPTSC)  $< -o $@

$(DOBJ)face_test_colors.o: src/third_party/FACE/src/tests/face_test_colors.f90 \
	$(DOBJ)face.o
	@echo $(COTEXT)
	@$(FC) $(OPTSC)  $< -o $@

$(DOBJ)face_test_ucs4.o: src/third_party/FACE/src/tests/face_test_ucs4.F90 \
	$(DOBJ)face.o
	@echo $(COTEXT)
	@$(FC) $(OPTSC)  $< -o $@
